...
class ProdutoUser(HttpUser):
    ...
    def on_start(self):
        ...
        if res_login.status_code == 200:
            ...
            if res_forn.status_code in [200, 201]:
                # Armazena o ID do fornecedor para reutilizar nas tarefas de produto
                # Tente 'id' ou 'idFornecedor' conforme sua API
    ...
    def fluxo_produto(self):
        ...
        # Descrição única para evitar problemas em campos que exijam exclusividade
