...
public class WelcomeEmailSender {
    @Async("taskExecutor") // Usa o TaskExecutor customizado definido em AsyncConfig
    public void sendWelcomeEmail(Cliente cliente) {
        try {
            // Simula o envio de e-mail, que pode ser uma operação demorada
            Thread.sleep(3000); // 3 segundos de atraso
            log.info("E-MAIL DE BOAS-VINDAS: E-mail enviado para {} (ID: {}) no endereço {}", cliente.getNome(), cliente.getId(), cliente.getEmail());
